  ...
  return (
    <div className="movie-card w-60 mx-1 rounded-lg overflow-hidden shadow-md transition-transform duration-300 hover:-translate-y-5 bg-gray-900 px-1">
      ...
      <div className="flex w-full justify-between my-2 gap-2 text-white">
        <button className="movie-classNameification text-sm rounded-md bg-red-500 w-1/4 text-white">
          {classification}
        </button>
        <button className="movie-format text-sm w-full border-2 rounded-md border-blue-700">
          {subtitles}
        </button>
        <button className="movie-director text-sm rounded-md bg-green-700 w-1/4 text-white">
          {format}
        </button>
      </div>
      ...
      {isSaleTicket ? (
        <div className="flex justify-between items-center rounded-b-md">
          ...
          <button
            className="detail-button bg-gray-700 text-white border-2 border-orange-700 px-4 py-2 rounded-md"
            onClick={openModal}
          >
            <a
        ...
        <div className="flex justify-between items-center rounded-b-md">
          <button
            className="detail-button bg-gray-700 text-white border-2 text-sm border-orange-700 px-4 py-2 rounded-md"
            onClick={openModal}
          >
            <a
              title="DORAEMON THE MOVIE: NOBITA'S EARTH SYMPHONY"
            ...
            >
              <span>
                <FontAwesomeIcon icon={faInfoCircle} /> Thông tin chi tiết
              </span>
            </a>
          </button>
        </div>
